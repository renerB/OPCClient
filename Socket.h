...
void sendDados_thread(SOCKET sock, char* ipaddr, char buf[50], int* nSeq, float* TempPreAq, float* TempAq, float* TempEnch, float* Vazao, char msgDados[], char msgAck[], int* status);;
